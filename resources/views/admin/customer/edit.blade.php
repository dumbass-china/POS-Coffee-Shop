    ...
    <div class="container-fluid mt-3">
        <div class="table-responsive" style="background-color: #ffffff">
            <div class="card-header" style="background-color: #3559e0; color: #ffffff">
                <h3 class="card-title" style="font-size: 35px">Edit Customer</h3>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 px-5 mt-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="companyname" class="form-control" id="companyname"
                                    ...
                                    value="{{ old('companyname', $customer->companyname) }}">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-6 px-5 mt-3">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="address" id="address" cols="30" rows="5" placeholder="Enter Address"
                                    style="color: #3559e0;">{{ old('address', $customer->address) }}</textarea>
                            </div>
                            ...
                            <div class="form-check form-switch mx-2">
                                ...
                                <input class="form-check-input fs-5" type="checkbox" id="ishiddenCheckbox" name="ishidden"
                                    value="1" {{ old('ishidden', $customer->ishidden) ? 'checked' : '' }}>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 px-4 mt-3 d-flex justify-content-end">
                                ...
                                <button type="submit" class="btn btn-block btn-default mx-3"
                                    style="background-color: #3559e0; width: 100px; color: #ffffff;">Save</button>
                            </div>
                        </div>
                    </div>
                </form>
